...
Elm.FamiliadaGame.make = function (_elm) {
   ...
   function (v) {
      return typeof v === "object" && "mode" in v && "user_id" in v && "playersList" in v && "readyQueue" in v && "redTeam" in v && "blueTeam" in v && "redTeamPoints" in v && "blueTeamPoints" in v && "currentQuestion" in v && "answersBoard" in v && "whoAnswering" in v && "answerValue" in v ? {_: {}
                                                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                                                     v.answerValue)} : _U.badPort("an object with fields `mode`, `user_id`, `playersList`, `readyQueue`, `redTeam`, `blueTeam`, `redTeamPoints`, `blueTeamPoints`, `currentQuestion`, `answersBoard`, `whoAnswering`, `answerValue`",
      v);
   });
